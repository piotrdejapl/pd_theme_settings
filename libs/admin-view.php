<?php
    ...
    // =============================================================================
    // THis i the function from Prefix_Add_CMB2_To_Settings_Page’ class form snipets library
    ...
    class Prefix_Add_CMB2_To_Settings_Page {
         ...
         * @var string
         */
        protected $screen_id = 'settings_page_ustawienia_motywu';
    ...
    function theme_settings() { ?>
        ...
        <div class="wrap">
            ...
            <h1 class="pts-heading">This is where I want my CMB2 fields to appear... </h1>

            <form action="options.php" method="post" >

                <?php settings_fields('pd_theme_settings_scripts_group'); ?>
